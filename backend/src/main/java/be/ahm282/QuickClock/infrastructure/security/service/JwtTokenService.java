...
public class JwtTokenService implements TokenProviderPort {
    ...
    @Override
    public String generateAccessToken(String username, String displayName, String displayNameArabic, Long userId, List<Role> roles) {
        return buildToken(username, displayName, displayNameArabic, userId, ACCESS_TOKEN_EXPIRATION_MS, "access", roles);
    }

    @Override
    public String generateRefreshToken(String username, String displayName, String displayNameArabic, Long userId) {
        return buildToken(username, displayName, displayNameArabic, userId, REFRESH_TOKEN_EXPIRATION_MS, "refresh", null);
    }

    private String buildToken(String username, String displayName, String displayNameArabic, Long userId, long validityMs, String type, List<Role> roles) {
        ...
        var builder = Jwts.builder()
                ...
                .claim("displayNameArabic", displayNameArabic)
                .claim("type", type)
