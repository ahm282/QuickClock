...
public interface TokenProviderPort {
    String generateAccessToken(String username, String displayName, String displayNameArabic, Long userId, List<Role> roles);
    String generateRefreshToken(String username, String displayName, String displayNameArabic, Long userId);
